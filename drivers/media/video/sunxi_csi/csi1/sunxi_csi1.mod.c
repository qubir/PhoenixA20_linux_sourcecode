...
__attribute__((section("__versions"))) = {
	...
	{ 0xfa2d2ff8, "v4l2_i2c_new_subdev_board" },
...
"depends=videobuf-core,videobuf-dma-contig,camera";


MODULE_INFO(srcversion, "9D5CFD4F3DEBFF05E24F457");
