...
MODULE_ALIAS("usb:v0BDAp8724d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v0BDAp1724d*dc*dsc*dp*icFFiscFFipFF*");
MODULE_ALIAS("usb:v0BDAp0724d*dc*dsc*dp*icFFiscFFipFF*");

MODULE_INFO(srcversion, "D64916E10ECCB4CE9AFA270");
