...
#define AXP_WAKEUP_PIO0         (1<<8)
#define AXP_WAKEUP_PIO1         (1<<9)
#define AXP_WAKEUP_PIO2         (1<<10)
#define AXP_WAKEUP_PIO3         (1<<11)
#define AXP_WAKEUP_PIO_ANY      (AXP_WAKEUP_PIO0 | AXP_WAKEUP_PIO1 | AXP_WAKEUP_PIO2 | AXP_WAKEUP_PIO3)
